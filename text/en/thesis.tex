...
Huge thanks go to my fianc\'ee. She has been very kind and selfless when I worked on this thesis and did not have time for daily chores. The same should also be said about my family -- they are the reason I can study computer science.

Lastly, I want to thank my friend Michal. Our weekly discussions about this work have helped me shape it to the current form.
}
% TODO: fix and formalize bibliography
...
\include{chap_related_work}
\include{chap_optical_music_recognition}
\include{chap_semisupervised_learning}
\include{chap_methodology}
\include{chap_experiments_and_results}
\include{chap_conclusion_and_future_work}
