...
~/interactive.sh ~/pyenv/bin/python3 main.py unet train --dataset improvement --val_pages 20 --sup_pages 99 --unsup_pages 551 --epochs 50 --inner_features 16
